    ...
    <div className="container mx-auto px-4 py-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="space-x-2">
          ...
          <Button onClick={() => router.push(`/admin/temples/${templeId}/fortunes/new`)}>เพิ่มเซียมซี</Button>
        </div>
      </div>
          ...
          <Card key={`${f.temple_id}-${f.fortune_number}`} className="p-6 bg-card/90 border-border/50">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="space-x-2 whitespace-nowrap">
                <Button variant="secondary" onClick={() => router.push(`/admin/temples/${templeId}/fortunes/${f.fortune_number}/edit`)}>แก้ไข</Button>
