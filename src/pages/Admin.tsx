            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                    <Card className="p-6 bg-card/90 border-border/50 flex flex-col items-start">
                        ...
                        <Button onClick={() => navigate("/admin/temples")}>ไปที่รายการวัด</Button>
                    </Card>
                    ...
                    <Card className="p-6 bg-card/90 border-border/50 flex flex-col items-start">
                        ...
                        <Button onClick={() => navigate("/admin/temples/new")}>เพิ่มวัด</Button>
                    </Card>
                    ...
                    <Card className="p-6 bg-card/90 border-border/50 flex flex-col items-start">
                        ...
                        <Button onClick={() => navigate("/admin/fortunes/new")}>เพิ่มเซียมซี</Button>
                    </Card>
                </div>
            </div>
        </GradientBackground>
